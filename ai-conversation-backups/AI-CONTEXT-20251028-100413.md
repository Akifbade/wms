...
**Last Updated:** 2025-10-28 10:04:13  
...
- Fix nginx config: Remove duplicate content, clean HTTPS setup
...
1. **Create backup:**
   ```powershell
   git tag backup-feature-name-20251028-100413
   ```
