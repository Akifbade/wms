...
export const WithdrawalModal: React.FC<WithdrawalModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(`✅ ${response.message || 'Withdrawal completed successfully!'}`);
      onSuccess();
      onClose();
    } catch (err: any) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => setFormData({ ...formData, withdrawnBoxCount: parseInt(e.target.value) || 0 })}
                min="1"
          ...
          <div className="flex items-center gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 font-bold transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
