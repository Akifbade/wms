...
async function handleCreateReturn(req, res) {
    try {
        ...
        console.log('[Materials] Uploaded files received:', uploadedFiles ? Object.keys(uploadedFiles) : 'NONE');
        console.log('[Materials] PhysicalReport files:', uploadedFiles?.physicalReport?.length || 0);
        ...
        if (uploadedFiles?.physicalReport && uploadedFiles.physicalReport.length > 0) {
            ...
            console.log('[Materials] ✅ Physical report saved:', physicalReportUrl);
