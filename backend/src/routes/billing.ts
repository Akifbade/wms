...
router.put('/settings', authenticateToken, authorizeRoles('ADMIN'), async (req: AuthRequest, res) => {
  try {
    const companyId = req.user!.companyId;
    const {
      storageRateType,
...
router.get('/charge-types', authenticateToken, async (req: AuthRequest, res) => {
  try {
    const companyId = req.user!.companyId;
...
router.get('/charge-types/:id', authenticateToken, async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
    const companyId = req.user!.companyId;
...
// Create charge type
router.post('/charge-types', authenticateToken, authorizeRoles('ADMIN', 'MANAGER'), async (req: AuthRequest, res) => {
  try {
    const companyId = req.user!.companyId;
    const {
      name,
...
// Update charge type
router.put('/charge-types/:id', authenticateToken, authorizeRoles('ADMIN', 'MANAGER'), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
    const companyId = req.user!.companyId;
    const {
...
// Delete charge type
router.delete('/charge-types/:id', authenticateToken, authorizeRoles('ADMIN'), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
    const companyId = req.user!.companyId;
...
// Create invoice
router.post('/invoices', authenticateToken, authorizeRoles('ADMIN', 'MANAGER'), async (req: AuthRequest, res) => {
  try {
    const companyId = req.user!.companyId;
    const {
      shipmentId,
...
// Record payment
router.post('/invoices/:id/payments', authenticateToken, authorizeRoles('ADMIN', 'MANAGER'), async (req: AuthRequest, res) => {
  try {
    const { id } = req.params;
    const companyId = req.user!.companyId;
    ...
    try {
      ...
      await sendNotification(companyId, 'PAYMENT_RECEIVED', {
...
router.post('/shipments/:id/advance', authenticateToken, authorizeRoles('ADMIN', 'MANAGER'), async (req: AuthRequest, res) => {
  try {
