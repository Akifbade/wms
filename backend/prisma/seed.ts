...
async function main() {
  ...
  if (!billingSettings) {
    billingSettings = await prisma.billingSettings.create({
      ...
      paymentInstructions: 'Payment due within 10 days. Use invoice number as reference.',
      termsAndConditions: 'All rates in KWD. 3 days grace period. Company not liable for damaged goods.',
