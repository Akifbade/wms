...
export const InvoiceSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Advanced Template Configuration Banner */}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mb-3">
                Access the full template customization system with 70+ configuration options for invoices and release notes
              </p>
              <ul className="text-xs text-gray-600 space-y-1 mb-4">
                <li>• Company branding & logo upload</li>
                <li>• Invoice & release note layouts</li>
                <li>• Custom colors, fonts & styling</li>
                <li>• Print settings & localization</li>
              </ul>
              <Link
